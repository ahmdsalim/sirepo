<x-app-layout title="Keamanan">
    <x-slot name="header">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Keamanan</h3>
                <p class="text-subtitle text-muted">Pengguna dapat mengubah pengaturan kemanan akun</p>
            </div>
                    ...
                    <div class="card-body">
                        <form id="formSecurity">
                            <div class="form-group mandatory my-2">
                                ...
                                <input type="password" name="current_password" id="current_password" class="form-control" autocomplete="current_password" placeholder="Password saat ini">
                            </div>
                            <div class="form-group mandatory my-2">
                                <label for="password" class="form-label">New Password</label>
                                <input type="password" name="password" id="password" class="form-control" autocomplete="password" placeholder="Password baru">
                            </div>
                            <div class="form-group mandatory my-2">
                                <label for="password_confirmation" class="form-label">Confirm Password</label>
                                <input type="password" name="password_confirmation" id="password_confirmation" autocomplete="password" class="form-control" placeholder="Konfirmasi password">
                            </div>
                    ...
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            ...
                            if (errors.hasOwnProperty('current_password')) {
                                ...
                                current_password.after(`<span class="invalid-feedback" role="alert">${errors.current_password[0]}</span>`)
                            }
                            ...
                            if (errors.hasOwnProperty('password_confirmation')) {
                                ...
                                password_confirmation.after(`<span class="invalid-feedback" role="alert">${errors.password_confirmation[0]}</span>`)
                            }
