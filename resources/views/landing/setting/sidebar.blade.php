        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h4>{{ __('landing.account-dropdown.settings') }}</h4>
                </div>
                <div class="card-body">
                    <ul class="nav nav-pills flex-column">
                        <li class="nav-item"><a href="{{ route('landing.setting') }}"
                                class="nav-link {{ Request::is('setting/profile') ? 'active' : '' }}">{{ __('landing.account-dropdown.profile') }}</a>
                        </li>
                        <li class="nav-item"><a href="{{ route('landing.keamanan') }}"
                                class="nav-link {{ str_contains(Route::current()->getName(), 'keamanan') ? 'active' : '' }}">{{ __('landing.account-dropdown.security') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
